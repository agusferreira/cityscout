...
const LOADING_MESSAGES_WITH_USER = [
  { text: "Searching local knowledge base...", emoji: "🔍" },
  { text: "Querying your personal preference signals...", emoji: "🧬" },
  { text: "Cross-referencing city data with your taste profile...", emoji: "🎯" },
  { text: "Fusing dual-corpus RAG results...", emoji: "🔗" },
  { text: "Crafting your hyper-personalized guide...", emoji: "✍️" },
  { text: "Running quality evaluation...", emoji: "📊" },
];
...
function GuidePageContent() {
  ...
  const LOADING_MESSAGES = userId
    ? LOADING_MESSAGES_WITH_USER
  ...
  return (
    <div className="min-h-screen py-12">
      ...
      <GuideSection
        ...
        userSignals={guideData.user_signals || []}
        scores={guideData.scores}
        city={guideData.city}
        dataSourcesUsed={
          guideData.user_signals
            ? [...new Set(guideData.user_signals.map((s) => s.source_type))]
            : []
        }
      />
      ...
      <div className="mx-auto mt-12 max-w-3xl border-t border-border px-4 pt-8 text-center">
        <p className="text-sm text-muted">
          ...
          {guideData.enhanced && " (dual-corpus)"}
